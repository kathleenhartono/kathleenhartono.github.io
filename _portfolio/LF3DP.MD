...
---
Description of the purpose/features of the design
Markdown table with off-the-shelf-parts
Markdown table (either separate or combined with the off-the-shelf-parts). 
